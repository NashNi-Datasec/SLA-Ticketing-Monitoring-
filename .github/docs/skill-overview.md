...
| **Report** | Result + What to do next (PR Scenarios 1–4) | Metadata + executive summary + P1/P2/P3 actions |
...
| `skills/mobile/react-native-security.md` | AsyncStorage, WebView, deep links, Expo secrets |
| `skills/mobile/flutter-security.md` | SharedPreferences, bad certificates, Dart WebView / deep links |
...
| `skills/backend/api-authorization.md` | BOLA, BFLA, mass assignment, webhook auth — API Top 10:2023 |
...
| Backend | 5 |
| Infra | 4 |
| **Total skill module files** | **35** (8 shared + 17 domain + 10 entry) |
