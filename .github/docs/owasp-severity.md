...
**OWASP Category** on a finding is the *type* of issue. Use **Web** Top 10:2021 (`A0n`), **API** Top 10:2023 (`APIn`), or **Mobile** Top 10:2024 (`Mn`) — whichever matches the **changed code**. Severity still comes from the Risk Rating calculator.
