...
| `lib/main.dart`                                                                                 | mobile: 1                               | shared, mobile (includes flutter-security.md)                |
| `src/screens/Home.native.tsx`                                                                   | mobile: 1                               | shared, mobile (includes react-native-security.md)           |
| `src/api/orders.ts`                                                                             | backend: 1                              | shared, backend (includes api-authorization.md)              |
